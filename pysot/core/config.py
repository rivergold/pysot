...
__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '/media/qfs/project-data/.r/rlogodetect/pysot-coco/crop511'
__C.DATASET.COCO.ANNO = '/media/qfs/project-data/.r/rlogodetect/pysot-coco/train2017.json'
